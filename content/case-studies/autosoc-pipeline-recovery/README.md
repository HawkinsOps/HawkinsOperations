...
abstract: >
  ...
  SUCCESS. Authority snapshot locked April 7: 324,074 cases, ~88% auto-close, 8,574
  escalations, 8/8 host coverage, 0 hard mismatches.
---

# SignalFoundry Pipeline Outage: Diagnosed and Restored in One Session

**One-line TL;DR:** Automated SOC pipeline went down, two root causes found and fixed in one session, 324,074 cases and counting.
...
| Metric | Value | Source |
|---|---|---|
| Total cases processed | 324,074 | Locked authority snapshot |
...
- **April 7:** Authority snapshot locked — 324,074 cases, ~88% auto-close, 8,574 escalations
...
|---|---|---|---|
| Total cases | 49,774 | 324,074 | +274,300 |
| Auto-close rate | ~89% | ~88% | -1% |
| Escalated cases | 2,478 | 8,574 | +6,096 |

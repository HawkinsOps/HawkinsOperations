...
| Splunk (query library) | 79 Splunk detection searches across 9 SPL files, offline from live pipeline but portfolio-published |
...
| Splunk (SPL) | 79 detection searches (9 files) | `content/detection-rules/splunk/` |
